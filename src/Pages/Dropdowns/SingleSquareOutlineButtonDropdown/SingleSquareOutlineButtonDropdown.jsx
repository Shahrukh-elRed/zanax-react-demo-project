...
import "./single-square-outline-button-dropdown.scss";

const SingleSquareOutlineButtonDropdown = ({ color, buttonText, dropdownHeader, dropdownItems, separatedLinkText, separatedLinkAction }) => {
    return (
        <div className="btn-group mt-2 mb-2">
            <button type="button" className={`btn btn-outline-${color} dropdown-toggle`} data-bs-toggle="dropdown">
...
export default SingleSquareOutlineButtonDropdown;